...
import { PlusCircle, X, Upload, Loader2, Image as ImageIcon, Video, Sparkles, FileText, CheckCircle2, Calendar, Clock, Pin } from 'lucide-react';
...
export default function PressAdminActions({ onArticleAdded }: { onArticleAdded?: (article: any) => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const saveRes = await saveSiteContent({
      ...
      contentType: 'list',
      metadata: { slug, title, category: finalCategory, date: formattedCardDate, publishedAt: isoPublishedAt, pinned },
    });
